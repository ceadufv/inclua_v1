CREATE DATABASE  IF NOT EXISTS `capes_ebook` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `capes_ebook`;
-- MySQL dump 10.13  Distrib 5.7.27, for Linux (x86_64)
--
-- Host: sistemas.cead.ufv.br    Database: capes_ebook
-- ------------------------------------------------------
...
CREATE TABLE `data` (
  ...
  `data` longtext,
  `time_access` int(11) NOT NULL,
  `status` varchar(64) DEFAULT '' COMMENT 'Talvez precise desse campo para ajudar a gerenciar processos pendentes como: foi feito reconhecimento de imagens? ja esta tudo carregado?',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13397 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB AUTO_INCREMENT=9656 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-09-11 10:50:47
